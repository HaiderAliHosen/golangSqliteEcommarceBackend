...
//CreateOrderPagedResponse ---
func CreateOrderPagedResponse(request *http.Request, orders []models.Order, page, pageSize, totalOrdersCount int, includes ...bool) map[string]interface{} {
	...
	return CreatePagedResponse(request, resources, "orders", page, pageSize, totalOrdersCount)
}
